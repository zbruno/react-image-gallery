...
var ImageViewer = (function (_Component) {
  ...
  _createClass(ImageViewer, [{
    ...
    value: function renderRequestButton() {
      ...
      var requestStatusClass = this.props.requestStatus ? 'active' : '';

      return _react2['default'].createElement(
        'div',
        { className: 'image-viewer-icon-button request-icon-button ' + requestStatusClass,
          onClick: function () {
            return _this.props.onRequest(_this.props.patientId);
          }
        },
        _react2['default'].createElement(
          'i',
    ...
    value: function renderProgressButton() {
      ...
      var progressStatusClass = this.props.progressStatus ? 'active' : '';

      return _react2['default'].createElement(
        'div',
        { className: 'image-viewer-icon-button progress-icon-button ' + progressStatusClass,
          onClick: function () {
            return _this2.props.onProgress(_this2.props.patientId);
          }
        },
        _react2['default'].createElement(
          'i',
...
ImageViewer.propTypes = {
  ...
  progressStatus: _react.PropTypes.bool.isRequired,
  requestStatus: _react.PropTypes.bool.isRequired
};
