...
var ImageGallery = (function (_Component) {
  ...
  _createClass(ImageGallery, [{
    ...
    value: function render() {
      ...
      var patientId = _props.patientId;

      if (patientId === undefined || progressStatus === undefined || requestStatus === undefined) {
        return null;
      }
...
ImageGallery.propTypes = {
  ...
  patientId: _react.PropTypes.number,
  progressStatus: _react2['default'].PropTypes.bool,
  requestStatus: _react2['default'].PropTypes.bool,
